...
<?php
/**
 * Project Meta Sidebar HARD CODED
 */
 
if (tribe_is_event() && is_single() && has_term('projects', 'tribe_events_cat') ) {
...
?>
	...
	<dl>
			...
			<dd class="tribe-meta-value">
				<?php
				$additional_fields = tribe_get_custom_fields();
                echo $additional_fields['Project Type'];
				?>
			</dd>
		    <dt> Hike Difficulty Rating </dt>
			<dd class="tribe-meta-value">
				<?php
				$additional_fields = tribe_get_custom_fields();
                echo $additional_fields['Hike Difficulty Rating'];
				?>
			</dd>
			<dt> Work Difficulty Rating </dt>
			<dd class="tribe-meta-value">
				<?php
				$additional_fields = tribe_get_custom_fields();
                echo $additional_fields['Work Difficulty Rating'];
				?>
			</dd>
	</dl>
</div>
